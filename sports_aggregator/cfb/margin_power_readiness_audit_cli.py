"""CLI for current-season Margin Power readiness diagnostics."""
...
from sports_aggregator.cfb.margin_power_readiness_audit import report
...
def _default_output_path(season: int) -> Path:
    return DEFAULT_OUTPUT_DIR / f"cfb_{int(season)}_margin_power_readiness_audit.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    output_path = (
        ...
        if args.output
        else _default_output_path(args.season)
    )
